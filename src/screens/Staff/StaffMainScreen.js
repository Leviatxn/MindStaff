...
export const StaffMainScreen =  ({ })=>{
    ...
    const [selectedEvent, setEventSelected] = useState("");
    const [selectedBooth, setBoothSelected] = useState("");
            ...
            <View style={{flex:4,justifyContent:'flex-start', alignItems:'center', backgroundColor:'white'}}>
                <View style={{height:'30%',width:'90%', backgroundColor:'white',borderWidth:1.5, borderRadius:25,borderColor:'#0D433D',flexDirection:'row',justifyContent: 'space-evenly',alignItems: 'center'}}> 
                    ...
                    <View style={{flex:9,flexDirection:'column',alignItems:'center',justifyContent:'center'}}>
                        <Text style={{fontSize:14, color:"rgb(13,67,61)",fontFamily: 'Prompt-Regular'}}>Staff No.</Text>
                        <Text style={{fontSize:40, color:"rgb(13,67,61)",fontFamily: 'Prompt-SemiBold'}}>{staffNumData}</Text>
                        <Text style={{fontSize:11, color:"rgb(13,67,61)",fontFamily: 'Prompt-Regular'}}>event : </Text>
                        <Text style={{fontSize:11, color:"rgb(13,67,61)",fontFamily: 'Prompt-Regular'}}>booth : </Text>
                    </View> 
